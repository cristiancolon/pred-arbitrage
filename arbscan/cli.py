...
def main(argv: list[str] | None = None) -> None:
    ...
    d = sub.add_parser("discover", help="match, review and pair newly listed markets as they appear")
    d.add_argument("--once", action="store_true", help="check both venues once and exit")
    ...
    try:
        if args.cmd == "catalog":
            ...
            _run(discover.run(cfg, db, once=args.once))
